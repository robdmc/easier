...
class Fitter:
    ...
    def plot(self, *, x=None, scale_factor=1, label=None, line_color=None, scatter_color=None, size=10, xlabel='x', ylabel='y', as_components=False):
        """
...
def classifier_evaluation_plots(trained_model, X_test, y_test, threshold=0.5, plots='confusion_matrix, variable_importance, roc_curve, precision_recall, lift'):
    """
