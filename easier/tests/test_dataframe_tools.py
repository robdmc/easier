from easier.dataframe_tools import pandas_time_to_utc_seconds, pandas_utc_seconds_to_time, slugify
...
class TestSlugify(TestCase):
    ...
    def test_iterable(self):
        ...
        self.assertListEqual(fixed, ['these', 'are_things', 'that_need_to_be', 'fixed_right_now'])
