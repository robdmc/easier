...
class TestDuckModel(TestCase):
    ...
    def test_bad_naming(self):
        duck = Duck(self.TEST_DB_FILE, overwrite=True, read_only=False)
    ...
    def test_dropping(self):
        ...
        duck = Duck(self.TEST_DB_FILE, overwrite=False, read_only=False)
    ...
    def test_inserting(self):
        ...
        duck2 = Duck(self.TEST_DB_FILE, overwrite=True, read_only=False)
        ...
        duck3 = Duck(self.TEST_DB_FILE, overwrite=False, read_only=False)
    ...
    def test_read_only(self):
        ...
        duck = Duck(self.TEST_DB_FILE, overwrite=False, read_only=True)
        ...
        with self.assertRaises(ValueError):
            Duck(self.TEST_DB_FILE, overwrite=True, read_only=True)
